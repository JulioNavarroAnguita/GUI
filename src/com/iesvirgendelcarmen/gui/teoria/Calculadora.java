...
class InterfazCalculadora extends JFrame {
	...
	private JButton boton7, boton8, boton9, botonMas, boton4, boton5, boton6, botonMenos, boton1,
		boton2, boton3, botonPor, boton0, botonC, botonIgual, botonDivision;
	...
	private void crearPanelResultado() {
		...
		//labelResultado.setAlignmentX(RIGHT_ALIGNMENT);
